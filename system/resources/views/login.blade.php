...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            ...
            <h3 style="text-align: center">KPPN Ketapang</h3>
            <div class="login-logo">
                <img style="width: 25%; display: block; margin: 0 auto;" src="{{ url('public') }}/kppn.png">
            </div><br>

            <hr> @include('components.utils.notif')
            <div class="login-form">
                <form action="login" method="POST">
                    @csrf <!-- Ini adalah Blade directive untuk menyisipkan token CSRF -->
